      ...
      <div class="row">
        ...
        @endif
          ...
          <div class="mb-5">
            ...
            <input type="number" id="jumlah_pesanan" class="form-control text-center @error('jumlah_pesanan') is-invalid @enderror" wire:model="jumlah_pesanan" value="1" autofocus>
